        ...
        <div class="shop_goods_show_left">
            ...
            <div id="preview">
                <div class=jqzoom id="spec-n1" onClick="window.open('/')">
                    <IMG height="350" src="http://192.168.225.188:8080/${images[0]}" jqimg="images/img04.jpg" width="350">
                </div>
                <div id="spec-n5">
                    <div class=control id="spec-left">
                        <img src="http://192.168.225.188:8080/${images[0]}" />
                    </div>
                    <div id="spec-list">
                        <ul class="list-h">
                            <#list images as img>
                                <li><img src="http://192.168.255.188:8080/${img}"> </li>
                            </#list>
                        </ul>
                    </div>
                    <div class=control id="spec-right">
                        <img src="http://192.168.255.188:8080/${images[0]}" />
                    </div>
